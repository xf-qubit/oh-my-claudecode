...
function normalizeTeamWorkerCliMode(value: unknown, envName: string = OMC_TEAM_WORKER_CLI_ENV): TeamWorkerCli | 'auto' {
...
function resolveWorkerCliPath(workerCli: TeamWorkerCli, env: NodeJS.ProcessEnv): string {
